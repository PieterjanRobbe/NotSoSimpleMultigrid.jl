...
import SimpleMultigrid: stencil2mat, TransferKind, R₁, P₁, Grid, MultigridCycle, V, W, F, Smoother, zero_x, MultigridIterable, μ_cycle!, F_cycle!, smooth!, residu, factor_twos, coarse_grid_correction!
